...
const CATEGORIES = [
  ...
  { key: 'FUNDAMENTAL_MACRO', label: '🌍 Makro' },
  { key: 'FUNDAMENTAL_ONCHAIN', label: '⛓️ Onchain' }
]
    ...
    <>
      ...
      <div className="stats-row">
        ...
        <div className="stat-card glass-card animate-in stagger-2">
          ...
          <div className="stat-label">🔧 Teknikal</div>
        </div>
        <div className="stat-card glass-card animate-in stagger-3">
          ...
          <div className="stat-label">🌍 Makro</div>
        </div>
        <div className="stat-card glass-card animate-in stagger-4">
          ...
          <div className="stat-label">⛓️ Onchain</div>
        </div>
      </div>
