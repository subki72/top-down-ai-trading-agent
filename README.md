...
```mermaid
graph TD
    subgraph Layer1 [1. Event & Trigger Layer]
        TV[External Market Signal] -->|JSON Payload| N8N_WH(n8n Webhook)
    end

    subgraph Layer2 [2. n8n Automation & Audit]
